...
var camera = new THREE.PerspectiveCamera(90, aspect, 0.3, 2000);
...
var bgcamera = new THREE.PerspectiveCamera(40, aspect, 0.1, 20000);
...
document.getElementById("encryptBtn").addEventListener("click", function() {
  ...
  document.getElementById("outputText").value = encrypt(inputText, shift);
});

document.getElementById("decryptBtn").addEventListener("click", function() {
  const inputText = document.getElementById("inputText").value;
  const shift = parseInt(document.getElementById("shift").value);
  document.getElementById("outputText").value = decrypt(inputText, shift);
});
